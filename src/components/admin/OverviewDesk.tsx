      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white border border-gray-200 rounded-xl shadow-sm p-6">
          ...
          <div className="space-y-3">
            ...
            <button onClick={() => onNavigateTab('epg')} className="w-full flex items-center justify-between p-4 rounded-xl border border-gray-200 hover:border-brand-crimson hover:bg-red-50 group transition-all text-left">
              <div className="flex items-center gap-3">
                <div className="bg-gray-100 p-2 rounded-lg group-hover:bg-brand-crimson group-hover:text-white transition-colors">
                  <Headphones className="w-5 h-5 text-gray-600 group-hover:text-white" />
                </div>
                <div>
                  <h4 className="font-bold text-gray-900">Programme Schedule</h4>
                  <p className="text-sm text-gray-500">Edit daily shows</p>
                </div>
              </div>
              <ArrowUpRight className="w-5 h-5 text-gray-400 group-hover:text-brand-crimson" />
            </button>
