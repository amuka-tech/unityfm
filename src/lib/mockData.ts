...
export const mockEpgSchedule: EpgProgram[] = [
  {
    ...
    presenter_name: 'Grace Akello & David Opio',
    presenter_role: 'Morning Show Anchors',
    presenter_image: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150',
    day_of_week: 'Monday',
    start_time: '06:00',
    end_time: '09:00',
    category: 'News & Talk Show',
    description: 'Wake up to the biggest headlines across Northern Uganda, newspaper review, weather, market commodity prices, and motivational interviews.',
    banner_image: 'https://images.unsplash.com/photo-1495344517868-8ebaf0a2044a?w=600',
    is_featured: true,
    is_live_broadcast: true,
  },
  {
    id: 2,
    show_name: 'Agribusiness Hub Lango',
    presenter_name: 'Okello Moses',
    presenter_role: 'Senior Agriculture Correspondent',
    presenter_image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150',
    day_of_week: 'Monday',
    start_time: '10:00',
    end_time: '11:30',
    category: 'Agriculture',
    description: 'Expert agronomy guidance, Shea butter processing, poultry tips, tractor rentals, and live market commodity price tracking across Lira, Gulu, and Dokolo.',
    banner_image: 'https://images.unsplash.com/photo-1590736969955-71cc94801759?w=600',
    is_featured: true,
    is_live_broadcast: false,
  },
  {
    id: 3,
    show_name: 'Unity Lunchtime News (Puro Luo)',
    presenter_name: 'Akol Beatrice',
    presenter_role: 'Luo Language Anchor',
    day_of_week: 'Monday',
    start_time: '13:00',
    end_time: '13:45',
    category: 'News',
    description: 'Comprehensive mid-day news bulletin delivered in fluent Leb-Lango, highlighting rural district assemblies, community health, and breaking local events.',
    is_featured: false,
    is_live_broadcast: true,
  },
  {
    id: 4,
    show_name: 'Northern Youth Spotlight & Beats',
    presenter_name: 'DJ Lira Vybez & Fiona Akao',
    day_of_week: 'Monday',
    start_time: '16:00',
    end_time: '18:00',
    category: 'Entertainment',
    description: 'Showcasing Northern Uganda musical talent, youth entrepreneurship startups, creative arts, and trending university talk.',
    is_featured: false,
    is_live_broadcast: false,
  },
  {
    id: 5,
    show_name: 'Unity News 8PM (Prime Bulletin)',
    presenter_name: 'Sarah Awor & Moses Okello',
    presenter_role: 'Lead News Anchors',
    presenter_image: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=150',
    day_of_week: 'Monday',
    start_time: '20:00',
    end_time: '21:00',
    category: 'News',
  ...
  {
    id: 6,
    show_name: 'Lango Sports Arena',
    presenter_name: 'Dennis Ogwang',
    presenter_role: 'Sports Director',
    presenter_image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150',
    day_of_week: 'Monday',
    start_time: '21:00',
    end_time: '22:00',
    category: 'Sports',
    description: 'In-depth analysis of FUFA Drum, Uganda Premier League match highlights, athlete profiles from Akii-Bua, and European football review.',
    is_featured: true,
    is_live_broadcast: true,
  },
  // Tuesday
  {
    ...
    end_time: '09:00',
    category: 'News & Talk Show',
    description: 'Morning discussion focusing on health, municipal education, and civic rights in Lira City.',
    is_live_broadcast: true,
  },
  {
    id: 8,
    show_name: 'Tekwaro: Luo Culture & Wisdom',
    presenter_name: 'Walter Odongo & Clan Elders',
    day_of_week: 'Tuesday',
    start_time: '20:00',
    end_time: '21:30',
    category: 'Culture',
    description: 'Fascinating weekly forum with renowned Lango clan chiefs exploring historical folklore, Luo proverbs, and customary dispute resolution.',
    is_featured: true,
    is_live_broadcast: false,
  }
];
